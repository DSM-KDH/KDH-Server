...
class WorkoutApiClient(
    ...
    private fun buildPrompt(request: RoutineCreateRequest, phase: Int): String {
        ...
        ### 필수 제약 조건
        1. 사용 가능 기구에 적힌 기구만 사용하는 운동을 제안해주세요.
        2. 사용 가능 기구에 없는 기구가 필요한 운동은 운동명, 설명, 대체 운동 어디에도 절대 포함하지 마세요.
        3. 기구가 필요 없는 맨몸 운동은 사용할 수 있습니다.
        4. 최근 생성된 운동과 최대한 겹치지 않게 다양한 운동을 제안해주세요.
        5. 응답은 반드시 지정된 JSON 형식으로만 출력해주세요. 설명 문장은 포함하지 마세요.
        6. 모든 운동명과 값은 한국어로 작성해주세요.
        7. 각 운동은 exercise_name과 reps_time 필드를 포함해야 합니다.
        """.trimIndent()
    }
